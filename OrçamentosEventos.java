package rodrigosalsabarman;

import java.util.Scanner;

public class OrçamentosEventos {
	...
	public static void main(String[] args) {
		...
		String cliente, localFesta, data, horário, tipoEvento, bebida1, bebida2, bebida3, bebida4;
